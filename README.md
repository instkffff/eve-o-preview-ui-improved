...
> **knowning bug** 
  * background image can't scale in low dpi screen cause by ui kit. and i do not get a plan to solve it. if you mind, just delete the background image and rebuild it.
